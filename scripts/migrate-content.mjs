...
const result = { schemaVersion: 1, revision: 'migration-2026-09-09', publishedAt: null, snapshotAt: '2026-09-09', places, stages, updates, media, regions: board.worldMap.regions.map(r => ({ id: r.id, name: r.name, note: r.note, status: r.id === 'misthalin' ? 'In progress' : 'Terrain only', estimate: r.progress, estimateBasis: 'Legacy author assessment; not a geographic measurement', estimateDate: null })), articles: [], tours: [], settings: [{ id: 'site', brand: BRAND, tagline: 'Gielinor, built by hand.', introduction: 'We’re Marc and David. We’re rebuilding the places we grew up exploring in RuneScape, using Minecraft and Conquest Reforged.', heroId: places[0].coverId, mapId: map.id, featuredPlaceIds: ['draynor-village', 'lumbridge-castle', 'wizards-tower'], galleryMediaIds: [...new Set(board.items.filter(i => i.featured).flatMap(i => i.images.map(m => manifest[m.src].id)))], focusStageId: 'lumbridge-north-to-draynor-manor-al-kharid-border', instagram: 'https://www.instagram.com/projectrunecraft/', substack: 'https://dhmorgan.substack.com', fundraiser: 'https://gofund.me/7dc3fc541', supportCopy: 'If you’d like to support the project, our existing fundraiser has the details. Following along and sharing a favourite build helps too.', aboutCopy: 'We’re Marc and David, two childhood friends who grew up on RuneScape and Minecraft. Now we’re recreating the places we remember, one room, road and landscape at a time. Conquest Reforged gives us the materials and small details to make those places feel lived in.', creditsCopy: 'Gielinor and RuneScape belong to Jagex. Minecraft belongs to Mojang and Microsoft. This is an independent fan project, not an official product or an endorsed partnership.\n\nBuilds by Marc and David, using Conquest Reforged, WorldEdit and supporting mods. Terrain foundations by Mefisto148, whose map the original build notes credit on CurseForge. Historical references and image captions are retained in the original build logs.\n\nLiterata and Source Sans 3 are distributed under the SIL Open Font License. Legacy RuneScape fonts are credited in the retained project archive.', privacyCopy: 'You can browse without a site account. Saved places and unfinished author drafts stay in this browser and can be cleared. Hosting processes requests to serve the website. External Instagram, Substack and fundraiser links have their own privacy policies. We do not run advertising or behavioural analytics here.', faq: [{ question: 'Can I visit or download the world?', answer: 'No public access or download details have been announced here. A finished build is a building milestone, not a release announcement.' }, { question: 'How is the world made?', answer: 'We build in Minecraft with Conquest Reforged, using WorldEdit and a terrain foundation credited to Mefisto148. Our build logs record the materials, experiments and changes along the way.' }], activeQuestion: 'Which detail in Draynor do you remember best?', ideasEnabled: false, ideaReviewer: '', retentionDays: 90 }] };
